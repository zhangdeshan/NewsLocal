...
(function() {
	 ...
	 */
	var URL = window.UEDITOR_HOME_URL || "/newsLocal/ueditor/";
	...
	window.UEDITOR_CONFIG = {
		...
		,
		toolbars : [ [ 'bold', 'italic', 'underline', 'autotypeset', '|',
				'forecolor', 'cleardoc', '|', 'rowspacingtop',
				'rowspacingbottom', 'lineheight', 'date', 'time', '|',
				'justifyleft', 'justifycenter', 'justifyright',
				'justifyjustify', '|', 'link', 'simpleupload' ] ]
